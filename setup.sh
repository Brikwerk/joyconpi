...
# Bluetooth + Sys Reqs
sudo apt install libbluetooth-dev bluez bluez-tools bluez-firmware libgirepository1.0-dev gcc libcairo2-dev pkg-config tmux python3-dev gir1.2-gtk-3.0 -y
...
# cd bdaddr && make
# # Changing address
# sudo ./bdaddr -i hci0 -r BD_ADDR_HERE
